...
export const CupomReciboModal = ({ pedido, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/90 backdrop-blur-sm flex items-center justify-center z-[200] p-4 print:p-0 print:bg-white print:static print:h-auto print:w-auto print:block print:overflow-visible">
            ...
            <div className="mt-24 mb-10 print:mt-0 print:mb-0 print:w-full print:h-full print:absolute print:top-0 print:left-0 print:bg-white">
                
                {formato === 'BOBINA' ? (
                    /* LAYOUT BOBINA TÉRMICA (80mm) */
                    <div className="bg-white w-full max-w-[350px] mx-auto p-6 shadow-2xl rounded-lg print:shadow-none print:max-w-none print:w-[80mm] print:mx-0 print:p-0 font-mono text-xs text-slate-800">
                    ...
                    /* LAYOUT PAPEL A4 */
                    <div className="bg-white w-full max-w-[800px] mx-auto p-10 shadow-2xl rounded-lg print:shadow-none print:max-w-none print:w-full print:mx-0 print:p-0 font-sans text-slate-900">
                        ...
                        <div className="flex justify-between items-start border-b-2 border-slate-800 pb-6 mb-8">
                            ...
                            <div className="text-right">
                                <h2 className="text-2xl font-black uppercase bg-slate-100 border-2 border-slate-800 px-4 py-2 rounded-lg inline-block print:border-black print:bg-white">
                                    RECIBO DE PAGAMENTO
                                </h2>
                                <p className="text-base font-bold mt-3">Pedido Nº: <span className="text-red-600 print:text-black">{pedido.id}</span></p>
                        ...
                        <div className="border-2 border-slate-200 p-6 mb-8 rounded-xl flex justify-between bg-slate-50 print:bg-white print:border-black">
                            <div>
                                <p className="text-xs font-black uppercase text-slate-400 mb-1 tracking-widest print:text-black">Sacado / Cliente</p>
                            ...
                            <div className="text-right">
                                <p className="text-xs font-black uppercase text-slate-400 mb-1 tracking-widest print:text-black">Informações Adicionais</p>
                        ...
                        <table className="w-full text-left border-collapse mb-8">
                            <thead className="bg-slate-100 border-y-2 border-slate-800 print:bg-white print:border-black">
                                <tr>
                            ...
                            <tbody>
                                {pedido.itens.map((item, index) => (
                                    <tr key={index} className="border-b border-slate-200 print:border-gray-300">
                                        <td className="py-3 px-2 text-sm font-mono text-slate-500 print:text-black">{item.produto.sku}</td>
                        ...
                        <div className="flex justify-end items-end mb-12 border-t-2 border-slate-800 pt-6 print:border-black">
                            <div className="w-72 space-y-2">
                                ...
                                <div className="flex justify-between">
                                    ...
                                    <span className="text-sm font-bold text-orange-600 print:text-black">- R$ {pedido.desconto.toFixed(2)}</span>
                                </div>
                                <div className="flex justify-between mt-4">
                                    <span className="text-xl font-black uppercase text-slate-800">Total Pago:</span>
                                    <span className="text-3xl font-black text-green-600 print:text-black">R$ {pedido.valorTotal.toFixed(2)}</span>
                                </div>
                        ...
                        <div className="text-center mt-16 pt-8">
                            <div className="w-1/2 mx-auto border-t-2 border-slate-400 pt-2 print:border-black">
