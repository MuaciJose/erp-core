...
import {
    ...
    AlertTriangle, Info, X, Store, FileText, Percent, ShieldAlert, Search, Loader2
} from 'lucide-react';
...
export const Configuracoes = () => {
    ...
    // =======================================================================
    // INTEGRAÇÃO COM A BRASIL API PARA BUSCA DE CNPJ E ENDEREÇO
    // =======================================================================
    const buscarCNPJ = async () => {
        const cnpjLimpo = config.cnpj.replace(/\D/g, ''); // Remove pontos e traços
        ...
        try {
            ...
            // Monta o endereço formatado a partir dos dados da Receita
                        ...
                        <div className="space-y-6 animate-fade-in">
                            ...
                            <div className="mt-8 p-6 bg-red-50 border border-red-200 rounded-2xl flex items-start gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-red-600 mt-1 mb-3 font-medium">Se ativado, o sistema deixará vender peças mesmo se o saldo no sistema for zero. (Isso pode bagunçar seu inventário).</p>
