...
public interface ProdutoRepository extends JpaRepository<Produto, Long> {
    ...
    List<Produto> buscarPorTermo(@Param("termo") String termo, @Param("empresaId") Long empresaId);
    ...
    @Query("SELECT p FROM Produto p WHERE p.referenciaOriginal = :referenciaOriginal AND p.id <> :id AND p.empresaId = :empresaId")
    List<Produto> findByReferenciaOriginalAndIdNotAndEmpresa(@Param("referenciaOriginal") String referenciaOriginal,
                                                             @Param("id") Long id,
